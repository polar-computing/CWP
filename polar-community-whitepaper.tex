...
We would like to thank our Steering Committee members: Paul Morin (Polar
Geospatial Center), Anne Nolin (Oregon), Craig Stewart (Indiana), Gerlis
Fugmann (APECS), Eric Larour (NASA) and Lynn Yarmey (RPI). We would like
to acknowledge support and help from Aymen Al-Saadi (Rutgers).
...
% \cite{Workshop2014}
% \cite{IGERT}
% \cite{Wilson_undated-yk}
% \cite{Datacarpentry_undated-zl}
% \cite{Prasad2011-dd}
% \cite{science_hack_day}
% \cite{Laws2007-dj}
% \cite{Neeman2008-mj}
% \cite{Polar-HPC_hackathon}
% \cite{Neeman2016-uz}
% \cite{Reerink2016-xr}
% \cite{FutureScape}
% \cite{Neeman2002-dk}
% \cite{Anslow2016-vf}
% \cite{Skytland2016-jk}
% \cite{Space_apps}
% \cite{Smart_communities_hackathon}
% \cite{Kennicutt2016-hn}
% \cite{Leckart2015-go}
% \cite{Open_data_hackathon}
% \cite{xsede_website}
% \cite{Hacking_medicin}
% \cite{Fakhri2016-pm}
% \cite{Nelson2007}
% \cite{HPC_Carpentry}
